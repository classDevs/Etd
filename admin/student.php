...
<body>
    <div class="topnav">
        ...
        <a class = "active" href="student.php">Gerer les Etudiants</a>
        <a href="module.php">Gerer les Modules</a>
        <a href="result.php">Gerer les Resultats</a>
    </div>
    <br><br><br>
    <a href="add-student.php" class="create">Ajouter Un Etudiant</a>
    <br><br><br><br>
        ...
        <tbody>
            <?php if ($res->num_rows >0){
                ...
                <tr>
                    ...
                    <td>3 Année licence SI</td>
                    <td class="actions">
                        <a href="#" class="edit">Editer</a>
                        <a href="#" class="trash">Supprimer</a>
                    </td>
                </tr>
            <?php }
            }
