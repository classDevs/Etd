...
<html>
<head>
    <title>Les Etudiants Non Admis </title>
    <style>
         body {
            margin: 0;
...
<div class="topnav">
    ...
    <center><h3>Les Etudiants Ajournee du Module <?php
        include ('../connect.php');
        if($_SESSION['mod']!=0){
            ...
            header('refresh:1;url=general-non-admitted-list.php');    
        }
    ?></h3></center>
   <table id="note" align="center">
    ...
    <?php
    if($count == 0){
        echo "<br><br><br><center><h2>Il n'y a pas des etudiants non admis</h2></center> ";
    }
    ?>
<div class="footer">
