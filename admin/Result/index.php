<?php
    ...
    FROM srms.results INNER JOIN srms.student ON srms.results.id_std = srms.student.id INNER JOIN srms.module ON srms.results.id_mod = srms.module.id  ORDER BY id_std');
    $stmt->execute();
